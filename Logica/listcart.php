                ...
                $html .='<div class="cart-item">
                    <a class="thumbnail" href="#">
                        <figure class="lazy-image-small" style="padding-top:100%">
                            <img class="product-thumb" src="../img/'. htmlspecialchars($producto->getFoto()) .'">
                        </figure>
                    </a>
                    <div class="content">
                        ...
                        <div class="actions">
                            ...
                            <a class="remove text-size--smallest" href="#" data-idproducto="'. htmlspecialchars($producto->getIDProducto()) .'">Eliminar</a>
                        </div>
                    </div>
                </div>';
            }
